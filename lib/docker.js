...
let cmplr = async (ctx, obj = {}) => {
    ...
    try {
         ...
         */
            ...
            // .replace(/"end"/gi, '\t}\n}')
            const fileName = (0, findclass_1.default)(newObj.code); // Temporary file name
            newObj.node = (0, child_process_1.spawn)("docker", [
                "run",
                "-i",
                "--rm",
                "openjdk:25-slim",
        ...
        (_b = newObj.node) === null || _b === void 0 ? void 0 : _b.setMaxListeners(0);
